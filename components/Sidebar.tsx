...
export default function Sidebar({ currentView, setCurrentView }: SidebarProps) {
  return (
    ...
    >
      <div className="p-6">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-[#FF9900] to-[#FF6600] bg-clip-text text-transparent">Shinobi Player</h1>
        ...
        {[
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-2 transition-all ${
              currentView === item.id ? 'bg-[#FF9900] text-black font-semibold shadow-lg shadow-[#FF9900]/30' : 'text-gray-300 hover:text-white hover:bg-white/5'
            }`}
          >
            <item.icon size={20} />
